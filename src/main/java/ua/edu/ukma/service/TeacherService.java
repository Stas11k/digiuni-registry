...
public class TeacherService {
    ...
    private void validate(Teacher t) {
        ...
        if (t.getFirstName() == null || t.getFirstName().isBlank()
                || t.getLastName() == null || t.getLastName().isBlank()) {
    ...
    public void updatePartial(int id, Optional<String> lastName, Optional<String> firstName, Optional<String> middleName,
                              ...
                              Optional<String> position, Optional<Department> department, Optional<String> degree,
                              Optional<String> title, Optional<LocalDate> hireDate, Optional<Double> workload) {
        ...
        if (degree.isPresent()) t.setDegree(degree.get().trim().isEmpty() ? null : degree.get());
        if (title.isPresent()) t.setTitle(title.get().trim().isEmpty() ? null : title.get());
